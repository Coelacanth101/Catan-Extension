    ...
    resizeBoard(size){
        ...
        if(size === 'large'){
            ...
            $(`#board`).html(`
                ...
                <img id="tile3" class="tile" data-direction="" src="./ocean.png">
                <img id="tile4" class="tile" data-direction="" src="./ocean.png">
                <img id="tile5" class="tile" data-direction="" src="./ocean.png">
                <img id="tile6" class="tile" data-direction="" src="./desert.png">
                <img id="tile7" class="tile" data-direction="" src="./desert.png">
                <img id="tile8" class="tile" data-direction="" src="./desert.png">
                <img id="tile9" class="tile" data-direction="" src="./ocean.png">
                <img id="tile10" class="tile" data-direction="" src="./ocean.png">
                <img id="tile11" class="tile" data-direction="" src="./desert.png">
                <img id="tile12" class="tile" data-direction="" src="./desert.png">
                <img id="tile13" class="tile" data-direction="" src="./desert.png">
                <img id="tile14" class="tile" data-direction="" src="./desert.png">
                <img id="tile15" class="tile" data-direction="" src="./ocean.png">
                <img id="tile16" class="tile" data-direction="" src="./ocean.png">
                <img id="tile17" class="tile" data-direction="" src="./desert.png">
                <img id="tile18" class="tile" data-direction="" src="./desert.png">
                <img id="tile19" class="tile" data-direction="" src="./desert.png">
                <img id="tile20" class="tile" data-direction="" src="./desert.png">
                <img id="tile21" class="tile" data-direction="" src="./desert.png">
                <img id="tile22" class="tile" data-direction="" src="./ocean.png">
                <img id="tile23" class="tile" data-direction="" src="./ocean.png">
                <img id="tile24" class="tile" data-direction="" src="./desert.png">
                <img id="tile25" class="tile" data-direction="" src="./desert.png">
                <img id="tile26" class="tile" data-direction="" src="./desert.png">
                <img id="tile27" class="tile" data-direction="" src="./desert.png">
                <img id="tile28" class="tile" data-direction="" src="./ocean.png">
                <img id="tile29" class="tile" data-direction="" src="./ocean.png">
                <img id="tile30" class="tile" data-direction="" src="./desert.png">
                <img id="tile31" class="tile" data-direction="" src="./desert.png">
                <img id="tile32" class="tile" data-direction="" src="./desert.png">
                <img id="tile33" class="tile" data-direction="" src="./ocean.png">
                <img id="tile34" class="tile" data-direction="" src="./ocean.png">
                <img id="tile35" class="tile" data-direction="" src="./ocean.png">
                <img id="tile36" class="tile" data-direction="" src="./ocean.png">
                <img id="tile37" class="tile" data-direction="" src="./ocean.png">
                <div id="node1" class="node"><div id="nodetouch1" class="nodetouch"></div></div>
                <div id="node2" class="node"><div id="nodetouch2" class="nodetouch"></div></div>
                <div id="node3" class="node"><div id="nodetouch3" class="nodetouch"></div></div>
                <div id="node4" class="node"><div id="nodetouch4" class="nodetouch"></div></div>
